...
export default function PookifiedExpenseTracker() {
  ...
  const currencies: CurrencyOption[] = [
    ...
    { code: 'NPR', symbol: 'रू', rate: 133.30, name: 'Nepalese Rupee' }
  ];
  ...
  // Pre-defined categories with cute emojis
  const categories = [
  ...
  return (
    <div className="p-4 bg-pink-50 min-h-screen font-sans">
      <div className="max-w-4xl mx-auto bg-white p-6 rounded-2xl shadow-lg border-2 border-pink-200">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Expenses Table */}
          <div className="overflow-hidden rounded-xl border-2 border-pink-200 bg-white">
